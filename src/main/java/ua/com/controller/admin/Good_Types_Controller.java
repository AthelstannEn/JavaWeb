...
public class Good_Types_Controller {
	...
	@PostMapping
	public String save(@ModelAttribute("goodType") @Valid Type goodType,BindingResult br, Model model, SessionStatus status,@PageableDefault Pageable pageable, @ModelAttribute("filter") TypeFilter filter){
