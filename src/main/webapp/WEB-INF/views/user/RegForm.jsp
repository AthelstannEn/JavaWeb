	...
	<div class="col-sm-12 col-xs-9 col-md-offset-3">
		<form:form class="form-horizontal" action="/RegForm" method="POST" modelAttribute="user">
			...
			<div class="form-group regText" style="margin-top:20px;">
    			<label for="fName" class="col-sm-2 control-label"><p style="color:red";>First Name</p></label>
    			<div class="col-sm-3">
  			...
  			<div class="form-group regText">
    			<label for="lastName" class="col-sm-2 control-label"><p style="color:red";>Last Name</p></label>
    			<div class="col-sm-3">
			...
			<div class="form-group regText">
    			<label for="email" class="col-sm-2 control-label"><p style="color:red";>Email</p></label>
    			<div class="col-sm-3">
			...
			<div class="form-group regText">
    			<label for="pw" class="col-sm-2 control-label"><p style="color:red";>Password</p></label>
    			<div class="col-sm-3">
			...
			<div class="form-group regText">
    			<label for="pwRep" class="col-sm-2 control-label"><p style="color:red";>Repeat Password</p></label>
    			<div class="col-sm-3">
  			...
  			<div class="form-group regText">
    			<label for="mobNum" class="col-sm-2 control-label"> <p style="color:red";> Mobile Phone Number</p></label>
    			<div class="col-sm-3">
  			...
  			<div class="form-group regText">
    			<label for="postCode" class="col-sm-2 control-label"><p style="color:red";>Post Code</p></label>
    			<div class="col-sm-3">
  			...
  			<div class="form-group regText">
    			<label for="country" class="col-sm-2 control-label"><p style="color:red";> Country</p></label>
    			<div class="col-sm-3">
  			...
  			<div class="form-group regText">
    			<label for="city" class="col-sm-2 control-label"> <p style="color:red";> City</p></label>
    			<div class="col-sm-3">
  			...
  			<div class="form-group regText">
    			<label for="homeAddress" class="col-sm-2 control-label"> <p style="color:red"; >Home Address </p></label>
    			<div class="col-sm-3">
