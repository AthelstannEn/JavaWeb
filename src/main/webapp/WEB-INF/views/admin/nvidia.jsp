			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li><a href="/admin/ramTypes">Ram size</a></li>
						<li><a href="/admin/nvidia">Nvidia Models</a></li>
							<li><a href="/admin/screan">Screan Size</a></li>
...
<div class="row">
	<div class="col-md-3 col-xs-12">
		...
		<form:form class="form-inline" action="/admin/nvidia" method="GET" modelAttribute="filter">
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/nvidia" method="POST" modelAttribute="nvidia">
					...
					<div class="form-group">
  					...
  					<div class="form-group">
    					<div class="col-sm-offset-2 col-sm-10">
      						...
      						<a class="btn btn-primary" href="/admin/nvidia/cancel">Cancel</a>      						
    					</div>
  					</div>
				</form:form>
			</div>
		...
		<div class="row">
			...
			<c:forEach items="${page.content}" var="nvidia">
				<div class="row">
					<div class="col-md-8 col-xs-8">${nvidia.type}</div>
					<div class="col-md-2 col-xs-2"><a class="btn btn-warning" href="/admin/nvidia/update/${nvidia.id}<custom:allParams/>">update</a></div>
					<div class="col-md-2 col-xs-2"><a class="btn btn-danger" href="/admin/nvidia/delete/${nvidia.id}<custom:allParams/>">delete</a></div>
				</div>
			</c:forEach>
	</div>
					...
					<div class="col-md-6 col-xs-6 text-center">
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
								<custom:sort innerHtml="Models asc" paramValue="type" />
								<custom:sort innerHtml="Models desc" paramValue="type,desc" />
							</ul>
						</div>
					</div>
					<div class="col-md-6 col-xs-6 text-center">
