...
<div class="row">
	<div class="col-md-3 col-xs-12">
		...
		<form:form class="form-inline" action="/admin/gpuTypes" method="GET" modelAttribute="filter">
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/gpuTypes" method="POST" modelAttribute="gpuType">
				...
				<div class="form-group">
					...
					<div class="form-group">
    					<label for="name" class="col-sm-2 control-label">Grammature</label>
    					<div class="col-sm-10">
  					...
  					<div class="form-group">
    					<div class="col-sm-offset-2 col-sm-10">
      						...
      						<a class="btn btn-primary" href="/admin/gpuTypes/cancel">Cancel</a>      						
    					</div>
  					</div>
				</form:form>
			</div>
		...
		<div class="row">
			<div class="col-md-8 col-xs-8"><h3>Grammature</h3></div>
			<div class="col-md-2 col-xs-2"><h3>Update</h3></div>
			<div class="col-md-2 col-xs-2"><h3>Delete</h3></div>
		</div>
			<c:forEach items="${page.content}" var="gpuType">
				<div class="row">
					<div class="col-md-8 col-xs-8">${gpuType.type}</div>
					<div class="col-md-2 col-xs-2"><a class="btn btn-warning" href="/admin/gpuTypes/update/${gpuType.id}<custom:allParams/>">update</a></div>
					<div class="col-md-2 col-xs-2"><a class="btn btn-danger" href="/admin/gpuTypes/delete/${gpuType.id}<custom:allParams/>">delete</a></div>
				</div>
			</c:forEach>
	</div>
					...
					<div class="col-md-6 col-xs-6 text-center">
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
								<custom:sort innerHtml="GPU asc" paramValue="type" />
								<custom:sort innerHtml="GPU desc" paramValue="type,desc" />
							</ul>
						</div>
					</div>
					<div class="col-md-6 col-xs-6 text-center">
